...
- `SweetsActionDX11_Game.sln` remains dependency-safe with `SWEETS_USE_EFFEKSEER=0`. Use `cmake --build build --config Debug` or the generated CMake solution for active Effekseer playback.
